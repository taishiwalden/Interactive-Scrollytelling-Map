var config = {
  ...
  chapters: [
    //TODO replace this data with data from the first point in your dataset
    {
      ...
      title: 'Jerusalem',
      description: 'Jerusalem is the capital of Israel.  It is one of the oldest cities in the world, and is considered holy to the three major Abrahamic religions—Judaism, Christianity, and Islam.',
      location: {
        "center": [
          35.22273,
          31.77285
    ...
    //TODO Copy-paste more chapters here - one for each point in your dataset!
    {
      ...
      title: 'Gaza Strip',
      description: '140 square mile strip of land controlled by Hamas since 2007 and subject to an Israeli blockade ever since, home to almost 2 million Palestinians',
      location: {
        "center": [
          34.42200,
          31.39543
    ...
    //TODO Copy-paste more chapters here - one for each point in your dataset!
    {
      ...
      description: 'The First Intifada, or First Palestinian Intifada, was a sustained series of Palestinian protests and violent riots in the West Bank, Gaza Strip, and within Israel. The protests were against the Israeli occupation of the West Bank and Gaza that had begun twenty years prior, in 1967.',
      location: {
        "center": [
          34.50321,
          31.52424
